---
status: completed
summary: Added `dark-factory prompt unapprove` command that reverses prompt approval, moves the file back to inbox with draft status, and renumbers remaining queue entries
container: dark-factory-228-add-prompt-unapprove
dark-factory-version: v0.69.0
created: "2026-03-30T18:55:33Z"
queued: "2026-03-30T19:59:17Z"
started: "2026-03-30T19:59:20Z"
completed: "2026-03-30T20:16:09Z"
---
...
- `pkg/prompt/prompt.go` — PromptStatus constants, `MarkApproved()`, `StripNumberPrefix()`, `NormalizeFilenames()`
</context>
...
- Sets status to `draft` via frontmatter write (no `MarkDraft()` exists — set the status field directly, same pattern as other status changes)
