...
<objective>
Run a full code review of the dark-factory repo root and generate a fix prompt for each Critical or Important finding.
</objective>

<context>
Read `CLAUDE.md` for project conventions.
Read `docs/dod.md` for Definition of Done criteria.
Read `docs/code-review-prompts.md` for the canonical explainer of this workflow.
...
ls prompts/review-dark-factory-*.md 2>/dev/null || echo "no fix prompts generated (clean review)"
</verification>
