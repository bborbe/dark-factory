#!/usr/bin/env bash
#
# Verifies the four version strings of dark-factory are aligned. Exits
# non-zero on any mismatch with a clear report.
#
# The four strings:
...
#
# The git tag is bound to CHANGELOG by autoRelease at release time.
#
# This is the install-time gate, NOT the precommit gate. Drift between
# binary and plugin versions during development is fine; this check exists
# to ensure they re-align before `make install` ships a new version to
